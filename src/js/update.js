...
const updateOptions = {
    ...
    gitUsername: "Nareneder",  // [Required] Your GitHub Username.

    appName: "testing_app", //[Required] The Name of the app archive and the app folder.
    appExecutableName: "testing_app.exe", //[Required] The Executable of the Application to be Run after updating.
